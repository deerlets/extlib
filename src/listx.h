...
/* copyed from linux-2.6.30 & linux-4.9.76 */
 ...
 * @__new : the new element to insert
 *
 * If @old was empty, it will be overwritten.
 */
static inline void list_replace(struct list_head *old, struct list_head *__new)
{
	__new->next = old->next;
 ...
 */
static inline void
hlist_move_list(struct hlist_head *old, struct hlist_head *__new)
{
